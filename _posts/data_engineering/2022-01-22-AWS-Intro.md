...
**The next screen is important!** The auto-generated password and secret access key (for accessing AWS from code) are only provided once. Before leaving the page, write down your access key, secret access key, and auto-generated password somewhere secure $-$ the access key and secret access key in particular are all that's required for anyone on the internet to access your AWS services through a Python script.
