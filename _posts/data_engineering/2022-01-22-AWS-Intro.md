...
A slight clarification: you can have on-premise cloud, and off-premise third-party cloud. On-premise: perhaps a custom solution. The downside here is that you need to invest in buying all the servers and maintaining them. It's hard to scale down once you've invested in the hardware $-$ they'll just be sitting there after you've paid for them. Also: you need a place to store all these servers! And then keep them cold, secure, pay for the electricity, etc.

Data security is arguably lower on-premise, versus just letting it be handled third-party. **Need to really know what you're doing to have better data security & recovery with on-premise.**

But the upside is you can conform to whatever security standards you want yourself.

Also worth mentioning that there are levels of abstraction. IaaS: dealing with EC2 and S3 yourself. Versus something like Beanstalk, which just abstracts a lot of that away.
