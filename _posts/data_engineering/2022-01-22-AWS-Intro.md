...
But the cloud is useful beyond making your personal life smoother: it can help your professional life, too. Not all of Amazon's servers are busy handling searches for shoes, or determining which users to show ads for _Elden Ring_. Some of these servers, in fact, are available for you to rent for yourself.

**The ability to rent these servers, without needing to buy and then maintain them, is the cloud's major offering.** If the cloud industry had a slogan, it would be _"Whatever resources you need, whenever you need them."_ If servers are like water droplets in a physical cloud, then the industry prides itself on users being able to mold that cloud into whatever size and shape best fits their needs.
...
Scale these three servers up to four, five, or more as your app's audience grows around Valentine's Day, and then back down to three as users' dating lives quiet down. Ditch the storage server entirely when you decide to pivot to a _Love is Blind_-style no-photo app.

Throughout this wild ride, **you only pay for what you use.** This, along with avoiding the upfront costs of purchasing the hardware yourself, drastically lowers the barriers to accessing computational resources.

## What is the cloud (officially)?
