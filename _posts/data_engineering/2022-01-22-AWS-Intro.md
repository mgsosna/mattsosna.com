...
A slight clarification: you can have on-premise cloud, and off-premise third-party cloud. On-premise: perhaps a custom solution. The downside here is that you need to invest in buying all the servers and maintaining them. But the upside is you can conform to whatever security standards you want yourself.
