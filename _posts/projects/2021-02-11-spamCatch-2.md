---
layout: post
title: Building a full-stack spam catching app - 2. The Backend
title-clean: Building a full-stack spam catching app <div class="a2">2. The Backend</div>
author: matt_sosna
...
<span style="font-size:18px">**3. The Frontend and Deployment** ([next post]({{  site.baseurl  }}/spamCatch-3))</span>
