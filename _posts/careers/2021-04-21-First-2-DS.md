...
Your experience will look like [entirely different roles]({{  site.baseurl  }}/DS-transition-1/#the-scalpel-versus-the-shovel) depending on the answer to this question. In analytics-heavy versus engineering-heavy role, you will have different source data (e.g. Excel files vs. databases), deliverables (e.g. a report vs. software), and people you interact with (e.g. business leadership vs. the engineering team).
