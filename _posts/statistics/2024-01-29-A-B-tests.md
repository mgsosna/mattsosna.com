...
Imagine you're running an e-commerce startup and just launched a "Products You Might Like" service. You spent a lot of money building what seemed like a great service, but customer engagement is way lower than you expected. Your company doesn't have much [runway](https://www.brex.com/journal/startup-runway), so getting these recommendations right is important. But what if changing the recommendation system actually _worsens_ engagement? How do you choose between potential alternatives without just pushing to prod and hoping for the best?

<center>
<img src="{{  site.baseurl  }}/images/statistics/a-b/intro_rec.png" height="90%" width="90%">
</center>

At its core, our failed launch is due to a crisis of decision-making.

these questions revolve around 


 _quantifying the difference in a metric between two versions_, of which **A/B testing** is the gold standard. Saving our startup will require an _experimentation_ mindset, where we use data to drive our decision-making. This blog post will cover experimentation and why it's important, how to set up A/B tests and interpret the results, and caveats and pitfalls to avoid.
