...
Imagine you're running an e-commerce startup and just launched a "Products You Might Like" service. Your internal testing seemed promising, but customer engagement is way lower than you expected. Your company doesn't have much [runway](https://www.brex.com/journal/startup-runway), so getting this service right is important. But what if changing the recommendation system actually _worsens_ engagement? How do you choose between potential alternatives without just pushing to prod and hoping for the best?

<center>
<img src="{{  site.baseurl  }}/images/statistics/a-b/intro_rec.png" height="90%" width="90%">
</center>

At its core, these questions revolve around _how to quantify the success of a product before it's launched_, of which **A/B testing** is the gold standard. In this post we'll cover what experimentation is and why it's important, how to set up A/B tests and interpret the results, and caveats and pitfalls to avoid.
