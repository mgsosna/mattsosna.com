...
Imagine you're running an e-commerce startup and just launched a "Products You Might Like" service. You spent a lot of money building what seemed like a great [recommender system](https://www.nvidia.com/en-us/glossary/recommendation-system/), but customer engagement is way lower than you expected. Your company doesn't have much [runway](https://www.brex.com/journal/startup-runway), so getting these recommendations right is important. But what if changing the algorithm actually _worsens_ engagement? How do you choose between potential alternatives without just pushing to prod and hoping for the best?

<center>
<img src="{{  site.baseurl  }}/images/statistics/a-b/intro_rec.png" height="90%" width="90%">
</center>

At its core, these questions revolve around _how we make decisions under uncertainty_, which is hard to do well without _relying on data_. Our botched launch -- and further failed iterations -- could have been avoided through **experimentation**, of which **A/B testing** is the gold standard. In this post, we'll cover experimentation and why it's important, how to set up A/B tests and interpret the results, and how to understand and avoid classic caveats and traps.
