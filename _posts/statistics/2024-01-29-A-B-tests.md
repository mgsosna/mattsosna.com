---
layout: post
title: Navigating Uncertainty with Statistics
author: matt_sosna
tags: statistics
---

**"What if?"** For every choice we make, there are dozens of others we turned down -- intentionally or not. When the choice is inconsequential, these alternate paths don't matter. But when it's a big decision, we really want to make sure we chose the right path.

What guides us in these moments? Imagine, for example, that you're running an e-commerce startup and just launched a "Products You Might Like" service. Your engineers invested a lot of time building what seemed like a great [recommender system](https://www.nvidia.com/en-us/glossary/recommendation-system/), but customer engagement is way lower than you expected. Your company doesn't have much [runway](https://www.brex.com/journal/startup-runway), so getting these recommendations right is important. **But what if changing the algorithm actually _worsens_ engagement?** How do you decide between a blind leap of faith or staying the course?
...
Let's start by taking a step back and looking at the options for making an important change.

First, how did we get into this situation where we blindly launched a product and
